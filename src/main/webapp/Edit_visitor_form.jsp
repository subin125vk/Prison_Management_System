...
<body>
<%@page import="visitor.Add_visitorDao,visitor.Add_visitor"%>  
<%  
String id=request.getParameter("id");  
Add_visitor u=Add_visitorDao.getRecordById(Integer.parseInt(id));  
%> 
	<div class="container">
				...
				<div class="user-details">
					<div class="input-box">
						<span class="details">Full Name</span> <input type="text"
							name="fullname" id="fullname" value="<%=u.getFullname()%>" placeholder="Enter your name" >
					</div>
					<div class="input-box">
						<span class="details">Prisoner Visited</span> <input type="text"
							name="prisonervisited" id="prisonervisited" value="<%=u.getPrisonervisited()%>"
							placeholder="Enter Prisoner Details">
					</div>
					<div class="input-box">
						<span class="details">ID Number</span> <input type="number"
							name="visitorid" id="visitorid" placeholder="Enter ID Number" value="<%=u.getVisitorid()%>">
					</div>
					<div class="input-box">
						<span class="details">Phone Number</span> <input type="text"
							name="phonenumber" id="phonenumber" value="<%=u.getPhonenumber()%>"
							placeholder="Enter Phone Number">
					</div>
					<div class="input-box">
						<span class="details">Time Of Visit</span> <input type="time"
							name="timeofvisit" id="timeofvisit" value="<%=u.getTimeofvisit()%>" placeholder="Time">
					</div>
					<div class="input-box">
